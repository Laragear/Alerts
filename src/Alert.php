...
class Alert implements Arrayable, Jsonable, JsonSerializable, Stringable
{
     ...
     * @codeCoverageIgnore
     *
     * @return array{persist_key: null|string, message: string, types: string[], links: array<string, string>, dismissible: bool, tags: string[]}
     */
     ...
     * @codeCoverageIgnore
     *
     * @param  array{persist_key: null|string, message: string, types: string[], links: array<string, string>, dismissible: bool, tags: string[]}  $data
     */
