...
class AlertCreateCommand extends GeneratorCommand implements PromptsForMissingInput
{
    ...
    /**
     * Check if the command doesn't want a view to be generated.
     */
    protected function withoutView(): bool
    {
        return $this->option('no-view') || strtolower($this->option('view')) === 'false';
    }
    ...
    protected function getOptions(): array
    {
        return [
            ...
            ['view', null, InputOption::VALUE_NONE | InputOption::VALUE_NEGATABLE, 'Specify a view name, or use "--no-view" or "false" to skip creating it.'],
        ];
    }
}
